...
const sections = [
  ...
  {
    title: "제7조 (이용자의 권리)",
    body: "이용자는 언제든지 자신의 개인정보에 대한 열람·정정·삭제·처리정지를 요청할 수 있으며, 회사는 이에 대해 지체 없이 필요한 조치를 하겠습니다.\n\n• 회원 탈퇴: 서비스 내 설정 메뉴에서 직접 탈퇴를 신청할 수 있습니다. 탈퇴 신청 후 7일간 유예 기간이 주어지며, 유예 기간 내 재로그인하여 탈퇴를 취소할 수 있습니다. 유예 기간(7일) 경과 시 모든 개인정보가 영구 삭제되며 복구할 수 없습니다.\n• 탈퇴 후 재가입: 탈퇴 완료 후 7일간 동일 계정으로의 재가입이 제한됩니다.\n• 기타 요청: 서비스 내 의견 보내기 또는 아래 고지된 연락처를 이용해 주시기 바랍니다.",
  },
  {
    title: "제8조 (쿠키 등)",
